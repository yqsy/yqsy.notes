...
对象|命令
-|-
物理卷(PV)|pvcreate<br/>pvremove<br/>pvchange<br/>pvdisplay<br/>pvscan<br/>pvs
卷组(VG)|vgcreate<br/>vgremove<br/>vgchange<br/>vgdisplay<br/>vgscan<br/>vgs
逻辑卷(LV)|lvcreate<br/>lvremove<br/>lvchange<br/>lvdisplay<br/>lvscan<br/>lvs

扩充/减少/重命名/转换
对象|命令
-|-
卷组(VG)|vgextend<br/>vgreduce<br/>vgrename<br/>vgconvert
逻辑卷(LV)|lvextend<br/>lvreduce<br/>lvresize<br/>lvrename<br/>lvconvert
