...
- [7. Quota磁盘配额](#7-quota磁盘配额)
    - [7.1. 使用限制](#71-使用限制)
    - [7.2. 相关指令](#72-相关指令)
- [RAID 容错式廉价磁盘阵列](#raid-容错式廉价磁盘阵列)
    - [RAID0 (等量模式,stripe): 性能模式](#raid0-等量模式stripe-性能模式)
    - [RAID1 (映射模式,mirror): 完整备份](#raid1-映射模式mirror-完整备份)
    - [RAID 1+0, RAID 0+1](#raid-10-raid-01)
    - [RAID 5](#raid-5)
- [8. 查看文件内容的多种方式](#8-查看文件内容的多种方式)
- [9. 常用命令](#9-常用命令)
...
## RAID0 (等量模式,stripe): 性能模式
使用相同型号与容量的磁盘来组成时,效果较佳,数据会被等量的放置在各个磁盘上面

## RAID1 (映射模式,mirror): 完整备份
