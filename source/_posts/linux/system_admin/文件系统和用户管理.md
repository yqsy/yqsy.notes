...
- [3. 密码忘记](#3-密码忘记)
    - [3.1. 一般用户密码忘记了](#31-一般用户密码忘记了)
    - [3.2. root密码忘记了](#32-root密码忘记了)
- [4. 文件属性](#4-文件属性)
    - [4.1. 改变文件属性与权限](#41-改变文件属性与权限)
        - [4.1.1. 文件权限](#411-文件权限)
            - [4.1.1.1. umask](#4111-umask)
- [5. 文件种类与扩展名](#5-文件种类与扩展名)
- [6. Hierarchy Standard (FHS)文件标准](#6-hierarchy-standard-fhs文件标准)
    - [6.1. 四个类型](#61-四个类型)
    - [6.2. 其实只定义出三层目录下面应该放置什么数据](#62-其实只定义出三层目录下面应该放置什么数据)
    - [6.3. 目录表格](#63-目录表格)
        - [6.3.1. 常见](#631-常见)
        - [6.3.2. /usr](#632-usr)
        - [6.3.3. /var](#633-var)
        - [6.3.4. centos7的链接](#634-centos7的链接)
    - [6.4. 目录树](#64-目录树)
- [7. 目录相关](#7-目录相关)
    - [7.1. 创建多层级目录](#71-创建多层级目录)
- [8. 文件隐藏属性](#8-文件隐藏属性)
- [9. 文件的特殊权限: SUID,SGID,SBIT](#9-文件的特殊权限-suidsgidsbit)
    - [9.1. SUID的作用](#91-suid的作用)
    - [9.2. SGID的作用](#92-sgid的作用)
    - [9.3. SBIT的作用](#93-sbit的作用)
    - [9.4. 权限设置](#94-权限设置)
    - [9.5. 大写S或大写T](#95-大写s或大写t)
- [10. 查看文件内容的多种方式](#10-查看文件内容的多种方式)
- [11. 常用命令](#11-常用命令)
- [12. 其他命令](#12-其他命令)
