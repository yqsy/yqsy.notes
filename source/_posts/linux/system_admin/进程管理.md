...
- [7. 调整程序的优先级别](#7-调整程序的优先级别)
- [8. /proc/*代表的含义](#8-proc代表的含义)
- [9. 关于fork和exec](#9-关于fork和exec)
    - [9.1. 面试题目经常出的,解题思路](#91-面试题目经常出的解题思路)
- [10. 处理僵尸进程](#10-处理僵尸进程)
...
<a id="markdown-3-常用的指令" name="3-常用的指令"></a>
# 3. 常用的指令
...
<a id="markdown-4-任务调度进程crond的使用" name="4-任务调度进程crond的使用"></a>
# 4. 任务调度进程crond的使用
...
<a id="markdown-41-crontab文件的含义" name="41-crontab文件的含义"></a>
## 4.1. crontab文件的含义
...
<a id="markdown-42-注意点" name="42-注意点"></a>
## 4.2. 注意点
...
<a id="markdown-5-终止进程" name="5-终止进程"></a>
# 5. 终止进程
kill
...
<a id="markdown-51-强制关闭了父进程" name="51-强制关闭了父进程"></a>
## 5.1. 强制关闭了父进程
子进程并不会因为父进程的关闭而自动关闭,子进程的`PPID`会由原来的xxx变成1,而正常关闭进程的操作中,父进程在自己终止时,会同时调用资源关闭子进程,释放内存


<a id="markdown-6-job-control" name="6-job-control"></a>
# 6. job control
```bash
...
<a id="markdown-7-调整程序的优先级别" name="7-调整程序的优先级别"></a>
# 7. 调整程序的优先级别
...
<a id="markdown-8-proc代表的含义" name="8-proc代表的含义"></a>
# 8. /proc/*代表的含义
| 文件名            | 文件内容                                                                 |
| ----------------- | ------------------------------------------------------------------------ |
...
<a id="markdown-9-关于fork和exec" name="9-关于fork和exec"></a>
# 9. 关于fork和exec
...
<a id="markdown-91-面试题目经常出的解题思路" name="91-面试题目经常出的解题思路"></a>
## 9.1. 面试题目经常出的,解题思路
...
<a id="markdown-10-处理僵尸进程" name="10-处理僵尸进程"></a>
# 10. 处理僵尸进程
