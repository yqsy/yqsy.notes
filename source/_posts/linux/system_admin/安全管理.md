...
<a id="markdown-123-tar备份案例" name="123-tar备份案例"></a>
## 12.3. tar备份案例
```bash
BACKDATE=`date +%y%m%d`
...
<a id="markdown-124-rsync备份案例" name="124-rsync备份案例"></a>
## 12.4. rsync备份案例
