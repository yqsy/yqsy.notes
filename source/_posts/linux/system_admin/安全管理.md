...
- [13. 备份(备份不是万能的,但是没有备份是万万不能的)](#13-备份备份不是万能的但是没有备份是万万不能的)
    - [13.1. 哪些数据具有备份的意义](#131-哪些数据具有备份的意义)
    - [13.2. 数据备份方式](#132-数据备份方式)
    - [13.3. 备份策略](#133-备份策略)
    - [13.4. tar备份案例](#134-tar备份案例)
    - [13.5. rsync备份案例(差异备份)](#135-rsync备份案例差异备份)
- [14. 备份案例](#14-备份案例)
...
<a id="markdown-12-fail2ban" name="12-fail2ban"></a>
# 12. Fail2ban
...
<a id="markdown-13-备份备份不是万能的但是没有备份是万万不能的" name="13-备份备份不是万能的但是没有备份是万万不能的"></a>
# 13. 备份(备份不是万能的,但是没有备份是万万不能的)


<a id="markdown-131-哪些数据具有备份的意义" name="131-哪些数据具有备份的意义"></a>
## 13.1. 哪些数据具有备份的意义
...
<a id="markdown-134-tar备份案例" name="134-tar备份案例"></a>
## 13.4. tar备份案例
```bash
BACKDATE=`date +%y%m%d`
...
<a id="markdown-135-rsync备份案例差异备份" name="135-rsync备份案例差异备份"></a>
## 13.5. rsync备份案例(差异备份)
...
<a id="markdown-14-备份案例" name="14-备份案例"></a>
# 14. 备份案例
