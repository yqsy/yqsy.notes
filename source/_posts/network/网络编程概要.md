...
- [12. 定时器的手段](#12-定时器的手段)
- [13. 进程间通信手段](#13-进程间通信手段)
- [14. 三次握手 四次挥手 TIME_WAIT FIN_WAIT2](#14-三次握手-四次挥手-time_wait-fin_wait2)
- [15. SO_REUSEPORT and SO_REUSEADDR](#15-so_reuseport-and-so_reuseaddr)
- [16. 非阻塞event loop的模型的不足](#16-非阻塞event-loop的模型的不足)
- [17. socket多线程串话问题](#17-socket多线程串话问题)
- [18. 多线程谨慎使用fork](#18-多线程谨慎使用fork)
- [19. 多线程不要使用signal](#19-多线程不要使用signal)
...
<a id="markdown-12-定时器的手段" name="12-定时器的手段"></a>
# 12. 定时器的手段
...
<a id="markdown-13-进程间通信手段" name="13-进程间通信手段"></a>
# 13. 进程间通信手段
...
<a id="markdown-14-三次握手-四次挥手-time_wait-fin_wait2" name="14-三次握手-四次挥手-time_wait-fin_wait2"></a>
# 14. 三次握手 四次挥手 TIME_WAIT FIN_WAIT2
...
<a id="markdown-15-so_reuseport-and-so_reuseaddr" name="15-so_reuseport-and-so_reuseaddr"></a>
# 15. SO_REUSEPORT and SO_REUSEADDR
...
<a id="markdown-16-非阻塞event-loop的模型的不足" name="16-非阻塞event-loop的模型的不足"></a>
# 16. 非阻塞event loop的模型的不足
...
<a id="markdown-17-socket多线程串话问题" name="17-socket多线程串话问题"></a>
# 17. socket多线程串话问题
...
<a id="markdown-18-多线程谨慎使用fork" name="18-多线程谨慎使用fork"></a>
# 18. 多线程谨慎使用fork
...
<a id="markdown-19-多线程不要使用signal" name="19-多线程不要使用signal"></a>
# 19. 多线程不要使用signal
