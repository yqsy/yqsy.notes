...
vgcreate myvg1 /dev/sda1

vgchange -a y myvg1

lvcreate myvg1 -n mylv1 -l 100%FREE

mkfs.xfs /dev/myvg1/mylv1 -f 
...
mkdir /disk1/reference /disk1/env

ln -s /disk1/reference ~/reference
ln -s /disk1/env ~/env
```
...
/disk1/env *(rw,async,anonuid=0,anongid=,no_subtree_check)
...
mkdir /root/raspi
mount pi1:/disk1/env /root/raspi

# fstab

vim /etc/fstab

pi1:/disk1/env /root/raspi nfs rw,soft,intr 0 0
...
<a id="markdown-10-天气温度pm指数" name="10-天气温度pm指数"></a>
# 10. 天气/温度/PM指数
