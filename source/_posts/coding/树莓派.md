...
* https://mirrors.tuna.tsinghua.edu.cn/help/docker-ce/ (清华docker源)
...
* https://hub.docker.com/_/owncloud/ (可以在arm下跑吗?)
* https://hub.docker.com/r/comzone/rpi-owncloud/ (这是arm的,不对,状态全写到树莓派里面了)
...
* https://hub.docker.com/r/scue/docker-opengrok/  (dockerfile下载的jar包跳转到github了,但是下载github速度慢,以后搞吧)

```bash
# 搭建
mkdir -p $HOME/opengrok/source
mkdir -p $HOME/opengrok/data

docker build https://github.com/scue/docker-opengrok.git \
  -t yqsy021/docker-opengrok:1.0

# sudo docker run --rm \
#     -v $HOME/opengrok/source:/src \
#     -v  $HOME/opengrok/data:/data \
#     -p 8888:8080 \
